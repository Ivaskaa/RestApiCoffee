...
public class OrderService {
    ...
    public Object buildOrder(OrderRequest orderRequest ) {
        ...
        if (orderRequest.getCoffeeOrders() != null){
            ...
            for(CoffeeOrderRequest coffeeOrderRequest : orderRequest.getCoffeeOrders()){
                ...
                if(coffeeOrder.getCoffee() == null){
                    ...
                    if (searchSize) {
                        exceptions.put("coffee size", "there is no size coffee with id " + coffeeOrderRequest.getSize().getId());
                    }
        ...
        if (orderRequest.getTeaOrders() != null){
            ...
            for(TeaOrderRequest teaOrderRequest : orderRequest.getTeaOrders()){
                ...
                if(teaOrder.getTea() == null){
                    exceptions.put("tea", "there is no coffee with id " + teaOrderRequest.getTea().getId());
                } else {
                    boolean searchSize = true;
                    ...
                    if (searchSize) {
                        exceptions.put("tea size", "there is no size coffee with id " + teaOrderRequest.getSize().getId());
                    }
        ...
        if (orderRequest.getSnackOrders() != null){
            ...
            for(SnackOrderRequest snackOrderRequest : orderRequest.getSnackOrders()){
                ...
                if(snackOrder.getSnack() == null){
                    exceptions.put("snack", "there is no coffee with id " + snackOrderRequest.getSnack().getId());
                } else {
                    boolean searchSize = true;
                    ...
                    if (searchSize) {
                        exceptions.put("snack size", "there is no size coffee with id " + snackOrderRequest.getSize().getId());
                    }
                    if (snackOrderRequest.getSauce() != null) {
                        ...
                        if (snackOrder.getSauce() == null) {
                            exceptions.put("snack syrup", "there is no syrup with id " + snackOrderRequest.getSauce().getId());
                        }
                    }
        ...
        if (orderRequest.getSandwichOrders() != null){
            ...
            for(SandwichOrderRequest sandwichOrderRequest : orderRequest.getSandwichOrders()){
                ...
                sandwichOrder.setSandwich(sandwichRepository.findById(sandwichOrderRequest.getSnack().getId()).orElse(null));
                if(sandwichOrder.getSandwich() == null){
                    exceptions.put("sandwich", "there is no coffee with id " + sandwichOrderRequest.getSnack().getId());
                } else {
                    boolean searchSize = true;
                    ...
                    if (searchSize) {
                        exceptions.put("sandwich size", "there is no size coffee with id " + sandwichOrderRequest.getSize().getId());
                    }
                    if (sandwichOrderRequest.getSauce() != null) {
                        ...
                        if (sandwichOrder.getSauce() == null) {
                            exceptions.put("sandwich syrup", "there is no syrup with id " + sandwichOrderRequest.getSauce().getId());
                        }
                    }
        ...
        if (orderRequest.getDessertOrders() != null){
            ...
            for(DessertOrderRequest dessertOrderRequest : orderRequest.getDessertOrders()){
                ...
                if(dessertOrder.getDessert() == null){
                    exceptions.put("dessert", "there is no coffee with id " + dessertOrderRequest.getDessert().getId());
                } else {
                    boolean searchSize = true;
                    ...
                    if (searchSize) {
                        exceptions.put("dessert size", "there is no size coffee with id " + dessertOrderRequest.getSize().getId());
                    }
        ...
        order.setTime(String.valueOf(orderRequest.getTime()));
        order.setDate(String.valueOf(orderRequest.getDate()));
